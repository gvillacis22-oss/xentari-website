...
// This file provides a clean import interface for all V2 components

export { HeroV2 } from "./HeroV2";
export { TrustBarV2 } from "./TrustBarV2";
export { WhoWeHelpV2 } from "./WhoWeHelpV2";
export { ServicesGridV2 } from "./ServicesGridV2";
export { MoneySystemV2 } from "./MoneySystemV2";
export { ToolsSectionV2 } from "./ToolsSectionV2";
export { AboutV2 } from "./AboutV2";
export { TestimonialsV2 } from "./TestimonialsV2";
export { FAQV2 } from "./FAQV2";
export { CTAV2 } from "./CTAV2";
export { CalculatorCTAV2 } from "./CalculatorCTAV2";

// Legacy exports (keeping for backwards compatibility)
export { ServicesV2 } from "./ServicesV2";
export { ServicesDetailV2 } from "./ServicesDetailV2";
